        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    RecoveryEmail = table.Column<string>(type: "nvarchar(256)", maxLength: 256, nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    NumOfCollections = table.Column<int>(type: "int", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_Novels", x => x.Id);
                    table.ForeignKey(
                        name: "FK_Novels_AuthorProfiles_AuthorProfileId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_NovelCategories", x => new { x.CategoriesId, x.NovelsId });
                    table.ForeignKey(
                        name: "FK_NovelCategories_Categories_CategoriesId",
                        column: x => x.CategoriesId,
                        principalTable: "Categories",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_NovelCategories_Novels_NovelsId",
                        column: x => x.NovelsId,
                        principalTable: "Novels",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    FavoriteNovelsId = table.Column<int>(type: "int", nullable: false),
                    FavoritedById = table.Column<int>(type: "int", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_NovelFavorites", x => new { x.FavoriteNovelsId, x.FavoritedById });
                    table.ForeignKey(
                        name: "FK_NovelFavorites_AspNetUsers_FavoritedById",
                        column: x => x.FavoritedById,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_NovelFavorites_Novels_FavoriteNovelsId",
                        column: x => x.FavoriteNovelsId,
                        principalTable: "Novels",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_NovelTags", x => new { x.NovelsId, x.TagsId });
                    table.ForeignKey(
                        name: "FK_NovelTags_Novels_NovelsId",
                        column: x => x.NovelsId,
                        principalTable: "Novels",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_NovelTags_Tags_TagsId",
                        column: x => x.TagsId,
                        principalTable: "Tags",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Reviews_AspNetUsers_ReaderId",
                        column: x => x.ReaderId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_ReadingProgresses_AspNetUsers_ReaderId",
                        column: x => x.ReaderId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_ReadingProgresses_Chapters_LastChapterId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_NovelCategories_NovelsId",
                table: "NovelCategories",
                column: "NovelsId");

            migrationBuilder.CreateIndex(
                name: "IX_NovelFavorites_FavoritedById",
                table: "NovelFavorites",
                column: "FavoritedById");

            migrationBuilder.CreateIndex(
                name: "IX_Novels_AuthorProfileId",
                table: "Novels",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_NovelTags_TagsId",
                table: "NovelTags",
                column: "TagsId");

            migrationBuilder.CreateIndex(
                name: "IX_ReadingProgresses_LastChapterId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ReadingProgresses_ReaderId_NovelId",
                table: "ReadingProgresses",
                columns: new[] { "ReaderId", "NovelId" },
                unique: true);

            migrationBuilder.CreateIndex(
                name: "IX_Reviews_NovelId_ReaderId",
                table: "Reviews",
                columns: new[] { "NovelId", "ReaderId" },
                unique: true);
